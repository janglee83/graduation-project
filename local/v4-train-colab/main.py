...
from qualification import Certificate, Major, MajorType
from affected_factor import ProductFactor, EnvironmentFactor, PRODUCT_FACTOR_TYPE, ENVIRONMENT_FACTOR_TYPE
import json
...
def mainFunction() -> tuple[float, Any, list[TaskLinkageRequest]]:
    ...
    df_certificate = pandas.read_csv('./certificates.csv')
    ...
    df_major = pandas.read_csv('./majors.csv')
    ...
    df_major_type = pandas.read_csv('./type_majors.csv')
    ...
    df_resource = pandas.read_csv('./resources.csv')
    ...
    df_task = pandas.read_csv('./tasks.csv')
