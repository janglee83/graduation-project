...
def mainFunction() -> tuple[float, Any, list[TaskLinkageRequest]]:
    ...
    df_affected_factor = pandas.read_csv(
        'import_data/medium/affected_factors_dataset.csv')
    ...
    df_certificate = pandas.read_csv('import_data/medium/certificates.csv')
    ...
    df_major = pandas.read_csv('import_data/medium/majors.csv')
